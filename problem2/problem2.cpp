...
int main() {
    ...
    for (int t = 0; t < 3; t++) {
        ...
        ofstream outFile(basePath + "problem2/output_test" + to_string(t+1) + ".txt");
        
        outFile << fixed << setprecision(6);
        outFile << "Problem No: 2\n";
    ...
    cout << "\nOutput saved to problem2/output_test1.txt, output_test2.txt, output_test3.txt\n";
